...
const BASIC_AUTENTICATION = 'basic-authentication'
const TWO_FACROR = 'two-factor'
...
export const SigningIn = () => {
  ...
  const credentialUniqueCategories = [
    ...new Set(credentials.filter((cred) => cred.category == BASIC_AUTENTICATION).map((c) => c.category)),
  ];
